...
export default function CuentasContables() {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => entitiesAPI.CuentaContable.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => entitiesAPI.CuentaContable.update(id, data),
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => entitiesAPI.CuentaContable.delete(id),
