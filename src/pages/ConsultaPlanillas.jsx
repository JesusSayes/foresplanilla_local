...
import {
  ...
  Loader2, Download, BookOpen, RefreshCw, AlertCircle, X, Building2
} from "lucide-react";
...
export default function ConsultaPlanillas() {
  ...
  const { data: afpList = [] } = useQuery({
    ...
    queryFn: () => base44.entities.AFP.list(),
  });
  const { data: payrollConcepts = [] } = useQuery({
    queryKey: ["payrollConceptsConsulta"],
    queryFn: () => base44.entities.PayrollConcept.list("-created_date", 5000),
  });
