...
export default function SubdiarioManagement() {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => base44.entities.Subdiario.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => base44.entities.Subdiario.update(id, data),
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => base44.entities.Subdiario.delete(id),
