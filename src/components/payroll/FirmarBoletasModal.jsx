        ...
        <div className="px-6 py-5 space-y-4">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="default" className="text-[10px] bg-indigo-100 text-indigo-700">GG</Badge>
                </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="default" className="text-[10px] bg-purple-100 text-purple-700">Delegado</Badge>
                </div>
          ...
          {selectedSigner.signature_url && (
            <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
              <img
                src={getPublicAssetUrl(selectedSigner.signature_url)}
                alt="Firma"
