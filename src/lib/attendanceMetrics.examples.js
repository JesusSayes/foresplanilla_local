 ...
 *
 *  getAdditionalMinutes Tiempo marcado DESPUÉS de la salida programada
 ...
 *
 *  HE 25%              Primeras 2h de getAdditionalMinutes (solo si autorizado).
 *  HE 35%              getAdditionalMinutes que excede 2h (solo si autorizado).
 *
